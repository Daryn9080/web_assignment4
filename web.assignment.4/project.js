...
function laptop() {
    return {
        ...
        descriptionEn: "Operating system · Central processing unit ; Microsoft Windows 10 Pro · Intel Core i5.",
        descriptionRu: "Операционная система · Центральный процессор ; Microsoft Windows 10 Pro · Intel Core i5.",
