...
function init(pageName) {
    if (pageName === "index") {
        let i
        const productNameElements = document.getElementsByClassName('product-name');
        for(let i = 0; i < productNameElements.length; i++){
            productNameElements[i].innerText = laptop().nameRu;
        }
        const productDescriptionElements = document.getElementsByClassName('product-description');
        for(i = 0; i < productDescriptionElements.length; i++){
            productDescriptionElements[i].innerText = laptop().descriptionRu;
        }
        const productImages = document.getElementsByClassName('card-img-top');
        for(i = 0; i < productImages.length; i++){
            productImages[i].src = laptop().imageSrc;
        }
    } else if (pageName === 'store') {
        let i
        const productNameElements = document.getElementsByClassName('nametovar');
        for(let i = 0; i < productNameElements.length; i++){
            productNameElements[i].innerText = laptop().nameRu;
        }
        const productImages = document.getElementsByClassName('tovar');
        for(i = 0; i < productImages.length; i++){
            productImages[i].src = laptop().imageSrc;
        }
        const productPrice = document.getElementsByClassName('price');
        for(i = 0; i < productPrice.length; i++){
            productPrice[i].innerText = laptop().price + '₸';
        }
        const productDiscount = document.getElementsByClassName('discount');
        for(i = 0; i < productDiscount.length; i++){
            productDiscount[i].innerText = laptop().discountPrice + '₸';
        }
    }
}
...
function EN(pageName) {
    ...
    if (pageName === 'index') {
        ...
        const productNameElements = document.getElementsByClassName('product-name');
        for(i = 0; i < productNameElements.length; i++){
            productNameElements[i].innerText = laptop().nameEn;
        }
        const productDescriptionElements = document.getElementsByClassName('product-description');
        for(i = 0; i < productDescriptionElements.length; i++){
            productDescriptionElements[i].innerText = laptop().descriptionEn;
        }
        const readMoreElements = document.getElementsByClassName('product-read-more');
